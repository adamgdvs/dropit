...
export default function TopBar() {
  ...
  return (
    <header className="flex items-center justify-end px-4 md:px-8 w-full h-14 md:h-0 bg-transparent sticky top-0 z-30">
      {/* Mobile logo */}
      <span className="md:hidden font-bold text-lg tracking-widest uppercase mr-auto">DROPIT</span>
